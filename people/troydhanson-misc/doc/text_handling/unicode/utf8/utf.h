...
static inline size_t utf8_charlen(uint8_t c) {
...
static inline size_t utf8_valid(const uint8_t *c) {
...
static inline uint32_t utf8_to_32(const uint8_t *c) {
  switch(utf8_valid(c)) {
    case 0: return 0;  /* invalid utf8 */
...
static inline size_t utf32_to_8(uint32_t utf32, uint8_t *utf8) {
  if (utf32 < 0x80) {
    *utf8 = (uint8_t)utf32;
    return 1; 
  }
