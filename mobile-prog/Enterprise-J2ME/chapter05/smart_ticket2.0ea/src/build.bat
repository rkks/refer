...
%JAVA_HOME%\bin\java -classpath "%ANT_CLASSPATH%" -Dant.home=%LOCAL_ANT_HOME% -DJ2EE.HOME=%J2EE_HOME% -DJ2MEWTK.HOME=%J2MEWTK_HOME% -DJAVA.HOME=%JAVA_HOME%  -DJ2EE_SCRIPT_SUFFIX=.bat org.apache.tools.ant.Main %1 %2 %3 %4
