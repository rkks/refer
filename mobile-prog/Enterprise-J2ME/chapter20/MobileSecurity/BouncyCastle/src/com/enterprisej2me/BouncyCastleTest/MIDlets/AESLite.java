...
public class AESLite extends MIDlet implements CommandListener {
  ...
  public AESLite () throws Exception {
  ...
  public void commandAction(Command command, Displayable screen) {
    if (command == exitCommand) {
      ...
      try {
        ...
        startTime = (new Date ()).getTime();
        encrypted = engine.AESLiteEncrypt(original);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
      ...
      try {
        startTime = (new Date ()).getTime();
        decrypted = engine.AESLiteDecrypt(encrypted);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
