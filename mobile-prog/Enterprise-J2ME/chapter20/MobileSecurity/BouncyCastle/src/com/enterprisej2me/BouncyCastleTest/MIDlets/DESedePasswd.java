...
public class DESedePasswd extends MIDlet implements CommandListener {
  ...
  public DESedePasswd () throws Exception {
  ...
  public void commandAction(Command command, Displayable screen) {
    if (command == exitCommand) {
      ...
      try {
        ...
        encrypted = engine.DESedePasswdEncrypt(original, passwd);
      ...
      try {
        ...
        startTime = (new Date ()).getTime();
        decrypted = engine.DESedePasswdDecrypt(encrypted, passwd);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
