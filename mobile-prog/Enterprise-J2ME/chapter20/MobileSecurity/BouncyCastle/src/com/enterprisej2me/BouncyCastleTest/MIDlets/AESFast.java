...
public class AESFast extends MIDlet implements CommandListener {
  ...
  public AESFast () throws Exception {
  ...
  public void commandAction(Command command, Displayable screen) {
    if (command == exitCommand) {
      ...
      try {
        ...
        startTime = (new Date ()).getTime();
        encrypted = engine.AESFastEncrypt(original);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
      ...
      try {
        startTime = (new Date ()).getTime();
        decrypted = engine.AESFastDecrypt(encrypted);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
