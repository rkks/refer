...
public class RSA extends MIDlet implements CommandListener {
  ...
  public void startApp() {
    Form form = new Form("RSA example");
  ...
  public void commandAction(Command command, Displayable screen) {
    if (command == exitCommand) {
      ...
      try {
        ...
        startTime = (new Date ()).getTime();
        encrypted = engine.RSAEncrypt(original);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
 
        Form form = new Form ("RSA Encrypted");
        form.append ("RSA encryption finished in " 
                     + interval + " millisec\n");
        form.append ("Result:\n");
      ...
      try {
        startTime = (new Date ()).getTime();
        decrypted = engine.RSADecrypt(encrypted);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
 
        Form form = new Form ("RSA Decrypted");
        form.append ("RSA decryption finished in " 
                     + interval + " millisec\n");
        form.append ("Result:\n");
