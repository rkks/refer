...
public class RC2Passwd extends MIDlet implements CommandListener {
  ...
  public RC2Passwd () throws Exception {
  ...
  public void commandAction(Command command, Displayable screen) {
    if (command == exitCommand) {
      ...
      try {
        ...
        encrypted = engine.PBEEncrypt(original, passwd);
      ...
      try {
        ...
        startTime = (new Date ()).getTime();
        decrypted = engine.PBEDecrypt(encrypted, passwd);
        endTime = (new Date ()).getTime();
        interval = endTime - startTime;
