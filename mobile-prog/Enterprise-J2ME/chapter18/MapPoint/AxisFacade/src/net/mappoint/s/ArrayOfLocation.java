...
public class ArrayOfLocation  implements java.io.Serializable {
    ...
    public net.mappoint.s.Location getLocation(int i) {
        return location[i];
    }

    public void setLocation(int i, net.mappoint.s.Location value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((location==null && other.getLocation()==null) || 
             (location!=null &&
              java.util.Arrays.equals(location, other.getLocation())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfLocation.class);
