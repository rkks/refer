...
public class FindResponse  implements java.io.Serializable {
    private net.mappoint.s.FindResults findResult;

    public FindResponse() {
    }

    public net.mappoint.s.FindResults getFindResult() {
        return findResult;
    }

    public void setFindResult(net.mappoint.s.FindResults findResult) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((findResult==null && other.getFindResult()==null) || 
             (findResult!=null &&
              findResult.equals(other.getFindResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFindResult() != null) {
            _hashCode += getFindResult().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindResponse.class);
