...
class DBManager {
    ...
    private DBManager() {
        ...
        syncurl =
            properties.getProperty("syncurl", "http://localhost:8123");
        String spokeid =
        ...
        url =
            properties.getProperty("url", "jdbc:pointbase:micro:pbdemo"+spokeid);
    ...
    private void connect() {
        try {
            ...
            System.out.println("Checking sync metadata...");
            loadMeta();
    ...
    void center(Window window) {
        ...
        int x=((d.width - w) / 3) * ( 1 + spoke_id );
        window.setBounds(x, (d.height - h) / 2, w, h);
    }
