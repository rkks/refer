...
static void bufferin_init PARAMS((BufferIn *in, char *command));
static void bufferout_init PARAMS((BufferOut *out, size_t lim));
...
int
untokenize (sic, pcommand, tokens)
     Sic *sic;
     char **pcommand;
     Tokens *tokens;
{
