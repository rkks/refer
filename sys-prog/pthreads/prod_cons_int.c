/*
 * Producer / Consumer Problem unterbrechbar durch SIGINT. Benutzt
 * signal thread und cancellation.
 *
...
struct thread_data *producer_data[MAXPRODUCERS];
int num_producers = 4;
